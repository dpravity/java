 ...
 * A를 밀어서 B가 될 수 있다면 밀어야 하는 최소 횟수를 return 하고 밀어서 B가 될 수 없으면 -1을 return 하도록 solution 함수를 완성해보세요.
 *
 * 제한사항
 * 0 < A의 길이 = B의 길이 < 100
...
public class StringPush {
    ...
    private static int solution3(String A, String B) {
        String tempB = B.repeat(3);
        return tempB.indexOf(A);
    }
    private static int solution4(String A, String B) {
